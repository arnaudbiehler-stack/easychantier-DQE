  ...
  try {
    ...
    const anthropicResp = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        ...
        // 4096 etait trop juste pour les plans avec beaucoup de pieces/elements : la reponse
        // JSON de l'IA se faisait couper avant la fin, ce qui cassait le parsing cote client
        // ("Réponse IA non structurée"). 8192 laisse largement plus de marge pour un metre complet.
        max_tokens: 8192,
        messages: [{
          role: 'user',
          content: [
